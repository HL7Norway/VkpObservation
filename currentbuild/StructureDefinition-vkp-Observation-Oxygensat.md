# Vkp VitalSigns Observation - Oxygen saturation - v0.3.4

* [**Table of Contents**](toc.md)
* [**Artifacts Summary**](artifacts.md)
* **Vkp VitalSigns Observation - Oxygen saturation**

## Resource Profile: Vkp VitalSigns Observation - Oxygen saturation 

| | |
| :--- | :--- |
| *Official URL*:http://hl7.no/fhir/vkpobservation/StructureDefinition/vkp-Observation-Oxygensat | *Version*:0.3.4 |
| Draft as of 2022-02-16 | *Computable Name*:VkpObservationOxygensat |

 
Profile for oxygen saturation in VKP. 

 
To record the eripheral oxygen saturation of an individual. 
...
Other representations of profile: [CSV](StructureDefinition-vkp-Observation-Oxygensat.csv), [Excel](StructureDefinition-vkp-Observation-Oxygensat.xlsx), [Schematron](StructureDefinition-vkp-Observation-Oxygensat.sch) 
...
```json
{
  ...
  "differential" : {
    "element" : [
      ...
      {
        "id" : "Observation.code.coding:OXSATSCT",
        "path" : "Observation.code.coding",
        "sliceName" : "OXSATSCT",
        "min" : 0,
        "max" : "*",
      ...
      {
        "id" : "Observation.code.coding:OXSATSCT.system",
        "path" : "Observation.code.coding.system",
        "min" : 1,
        "patternUri" : "http://snomed.info/sct"
      },
      {
        "id" : "Observation.code.coding:OXSATSCT.code",
        "path" : "Observation.code.coding.code",
        "min" : 1,
        "patternCode" : "431314004"
      },
      {
