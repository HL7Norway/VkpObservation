# Vkp VitalSigns Observation - Blood pressure - v0.3.9

* [**Table of Contents**](toc.md)
* [**Artifacts Summary**](artifacts.md)
* **Vkp VitalSigns Observation - Blood pressure**

## Resource Profile: Vkp VitalSigns Observation - Blood pressure 

| | |
| :--- | :--- |
| *Official URL*:http://hl7.no/fhir/vkpobservation/StructureDefinition/vkp-Observation-Bloodpressure | *Version*:0.3.9 |
| Draft as of 2022-02-10 | *Computable Name*:VkpObservationBloodpressure |

 
Profile for blood pressure in VKP. 
...
Other representations of profile: [CSV](StructureDefinition-vkp-Observation-Bloodpressure.csv), [Excel](StructureDefinition-vkp-Observation-Bloodpressure.xlsx), [Schematron](StructureDefinition-vkp-Observation-Bloodpressure.sch) 
