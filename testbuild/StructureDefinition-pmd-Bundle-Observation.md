# A bundle of observations for processing by Pasientens måledata - v0.5.0
...
| | |
| :--- | :--- |
| *Official URL*:http://hl7.no/fhir/vkpobservation/StructureDefinition/pmd-Bundle-Observation | *Version*:0.5.0 |
