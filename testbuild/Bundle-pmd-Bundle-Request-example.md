# Pmd bundle example - v0.4.1

* [**Table of Contents**](toc.md)
* [**Artifacts Summary**](artifacts.md)
* **Pmd bundle example**

## Example Bundle: Pmd bundle example
...
```json
{
  ...
  "meta" : {
    "profile" : ["http://hl7.no/fhir/vkpobservation/StructureDefinition/pmd-Bundle-Observation"]
  },
  "type" : "batch",
  "entry" : [{
