# vkp-blood-pressure-profile-create - v0.5.1
...
**performer**: Identifier: Foedselsnummer/103
...
```json
{
  ...
  "meta" : {
    ...
    "source" : "META_VISION",
    "profile" : ["http://hl7.no/fhir/vkpobservation/StructureDefinition/vkp-Observation-Bloodpressure"]
  },
  "identifier" : [{
