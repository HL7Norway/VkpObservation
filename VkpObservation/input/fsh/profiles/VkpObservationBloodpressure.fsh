...
* subject.identifier.system from http://hl7.no/fhir/vkpobservation/ValueSet/vkp-performer-identifiers.valueset (required)
...
* performer.identifier.system from http://hl7.no/fhir/vkpobservation/ValueSet/vkp-subject-identifiers.valueset (required)
