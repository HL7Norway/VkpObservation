...
* bodySite.coding.value from $no-bloodpressurebodysite-valueset (required)
...
* method.coding.value from $no-domain-vitalsignsobservation-measurementmethodvalueSet (required)
