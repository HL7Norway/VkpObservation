...
* subject.identifier.system from http://hl7.no/fhir/ValueSet/vkp-subject-identifiers.valueset (required)
...
* performer.identifier.system from http://hl7.no/fhir/ValueSet/vkp-subject-identifiers.valueset (required)
