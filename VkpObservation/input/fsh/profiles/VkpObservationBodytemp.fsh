Profile: VkpObservationBodytemp
...
* ^url = "http://hl7.no/fhir/StructureDefinition/vkp-Observation-Bodytemp"
* ^version = "0.1.0"
* ^status = #draft
* ^date = "2022-03-16"
...
* code.coding contains
  BodyTempSCTCode 0..* MS
* code.coding[BodyTempSCTCode].system = $sct
