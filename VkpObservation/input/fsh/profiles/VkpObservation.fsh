...
* performer contains
    author 0..* and
    organization 0..*
* performer[author] ^description = "Reference to the person, role or team that performed the observation, identified by Norwegian national id number (Fødselsnummer or DNR)."
...
* performer[organization] ^description = "Reference to the organization responsible for the information (opprinnelig dataansvarlig virksomhet)"
