...
Alias: $no-bloodpressurebodysite-valueset = http://hl7.no/fhir/ValueSet/no-domain-bp-bodysitevalueset
Alias: $no-domain-vitalsignsobservation-measurementmethodvalueSet = http://hl7.no/fhir/ValueSet/no-domain-measurementmethodvalueSet
